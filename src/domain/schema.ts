...
export const EventPayloadSchema = Schema.Union(
  ...
  Schema.TaggedStruct("integration_started", { commitId: CommitId, operationId: Identifier }),
  Schema.TaggedStruct("integration_succeeded", { commitId: CommitId, operationId: Identifier }),
...
const payloadKeys: Readonly<Record<string, readonly string[]>> = {
  ...
  integration_started: ["_tag", "commitId", "operationId"],
  integration_succeeded: ["_tag", "commitId", "operationId"],
